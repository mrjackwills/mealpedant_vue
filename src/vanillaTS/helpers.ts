...
export const todayDateString = (): string => new Date(Date.now() - new Date().getTimezoneOffset() * 60000).toISOString().slice(0, 10);

/// Genesis date as string yyyy-mm-dd
export const genesisDateString = (): string => new Date(genesisDate).toISOString().slice(0, 10);
